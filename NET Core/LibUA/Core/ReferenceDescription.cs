...
// Type: LibUA.Core.ReferenceDescription
...
namespace LibUA.Core
{
    public class ReferenceDescription
    {
        ...
        public NodeId TargetId { get; protected set; }

        public QualifiedName BrowseName { get; protected set; }

        public LocalizedText DisplayName { get; protected set; }

        public NodeClass NodeClass { get; protected set; }

        public NodeId TypeDefinition { get; protected set; }
